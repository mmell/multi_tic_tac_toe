...
g = MultiTicTacToe::Game.new(3, 4, player_ct: 3) # 3 dimensions, 4 grid, 3 players
g.move( 0, 0, 0 ) # P1
g.move( 2, 0, 1 )
g.move( 2, 0, 2 )
g.move( 3, 3, 3 ) # P1
...
g.move( 1, 0, 1 )
g.move( 1, 0, 2 )
g.move( 2, 2, 2 ) # P1 winner!

g = MultiTicTacToe::Game.new(10, 3, player_ct: 4) # 10 dimensions, 3 grid, 4 players
